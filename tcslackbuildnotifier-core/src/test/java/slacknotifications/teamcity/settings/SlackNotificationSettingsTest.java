...
public class SlackNotificationSettingsTest {
    ...
    @Ignore
    @Test
    public void test_AuthFailWrongCredsUsingProxyFromConfig() throws IOException, InterruptedException {
        ...
        assertEquals((int) w.getStatus(), HttpServletResponse.SC_PROXY_AUTHENTICATION_REQUIRED);
    }

    @Ignore
    @Test
    public void test_AuthFailNoCredsUsingProxyFromConfig() throws IOException, InterruptedException {
        String expectedConfigDirectory = ".";
        ServerPaths serverPaths = mock(ServerPaths.class);
        when(serverPaths.getConfigDir()).thenReturn(expectedConfigDirectory);
	...
	*/
    ...
    public void test_WebookConfig() throws JDOMException, IOException {
        ...
        if (root.getChild("slackNotifications") != null) {
            ...
            if ((child.getAttribute("isEnabled") != null) && (child.getAttribute("isEnabled").toString().equals("true"))) {
