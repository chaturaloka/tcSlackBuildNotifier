...
public class SlackNotificationMainConfig implements ChangeListener {
    ...
    String getProxySettingsAsString() {
    ...
    private Element getInfoUrlAsElement() {
		/*
    ...
    private Element getProxyAsElement() {
		/*
    ...
    void setProxyShortNames(Boolean proxyShortNames) {
        this.proxyShortNames = proxyShortNames;
    }

    String getSlackNotificationInfoUrl() {
            ...
            public void run() {
                FileUtil.processXmlFile(SlackNotificationMainConfig.this.myConfigFile, new FileUtil.Processor() {
                    public void process(Element rootElement) {
                        rootElement.setAttribute("isEnabled", Boolean.toString(SlackNotificationMainConfig.this.enabled));
    ...
    SlackNotificationProxyConfig getProxyConfig() {
