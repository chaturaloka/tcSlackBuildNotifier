...
<div id="settingsContainer">
    <form action="${actionUrl}" id="slackNotifierAdminForm" method="post" onsubmit="return SlackNotifierAdmin.save()">
        <div class="editNotificatorSettingsPage">
            <div>
                <span class="slackNotifierVersionInfo">Version: <c:out value='${pluginVersion}'/>&nbsp;<a
                        href="https://github.com/petegoo/tcSlackBuildNotifier" class="helpIcon"
                        style="vertical-align: middle;" target="_blank"><bs:helpIcon/></a></span>
            </div>
            <c:choose>
                <c:when test="${disabled}">
                    <div class="pauseNote" style="margin-bottom: 1em;">
                        The notifier is <strong>disabled</strong>. All slack notifications are suspended&nbsp;&nbsp;<a
            ...
            <table class="runnerFormTable">
                <tr class="groupingTitle">
                    <td colspan="2">General Configuration&nbsp;<a href="https://github.com/petegoo/tcSlackBuildNotifier"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="smallNote">A user OAuth token for your team. You can get this from the <a
                                href="https://api.slack.com/web" target="_blank">api page</a> when you are signed in to your team. If you are using the "Incoming WebHooks" integration you can simply enter the webhook URL in here instead.</span>
                    </td>
                </tr>
                <tr>
                    <th>
                ...
                <tr>
                    ...
                    <td>
                        <forms:checkbox name="showElapsedBuildTime" checked="${showElapsedBuildTime}"
                                        value="${showElapsedBuildTime}"/>
                ...
                <tr>
                    ...
                    <td>
                        <forms:textField name="maxCommitsToDisplay" value="${maxCommitsToDisplay}"
                                         style="width: 70px;"/>
                ...
                <tr>
                    ...
                    <td>
                        <forms:checkbox name="showFailureReason" checked="${showFailureReason}"
                                        value="${showFailureReason}"/>
                ...
                <tr>
                    ...
                    <td>
                        <forms:passwordField name="proxyPassword" encryptedPassword="${encryptedProxyPassword}"
                                             style="width: 300px;"/>
            ...
            <div class="saveButtonsBlock">
                ...
                <forms:submit id="testConnection" type="button" label="Send test notification"
                              onclick="return SlackNotifierAdmin.sendTestNotification()"/>
                <forms:saving/>
            </div>
        </div>
    </form>
