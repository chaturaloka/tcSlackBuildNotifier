...
public class SlackNotificationIndexPageController extends BaseController {
    ...
    protected ModelAndView doHandle(@NotNull HttpServletRequest request, @NotNull HttpServletResponse response) {
        ...
        if (request.getParameter(PROJECT_ID) != null) {
            ...
            if (project != null) {
                ...
                fillPermissionsInParam(request, params, project);
                params.put("haveProject", "true");
                params.put("messages", projSettings.getSlackNotificationsAsString());
    ...
    private void fillPermissionsInParam(@NotNull HttpServletRequest request, HashMap<String, Object> params, SProject project) {
