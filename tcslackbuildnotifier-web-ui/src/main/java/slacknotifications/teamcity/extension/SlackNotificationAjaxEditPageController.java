...
public class SlackNotificationAjaxEditPageController extends BaseController {
    ...
    static void checkAndAddBuildStateIfEitherSet(HttpServletRequest r, BuildState state) {
        if ((r.getParameter(SlackNotificationAjaxEditPageController.BUILD_SUCCESSFUL) != null)
                && ("on".equalsIgnoreCase(r.getParameter(SlackNotificationAjaxEditPageController.BUILD_SUCCESSFUL)))) {
            state.enable(BuildStateEnum.BUILD_FINISHED);
        } else if ((r.getParameter(SlackNotificationAjaxEditPageController.BUILD_FAILED) != null)
                && ("on".equalsIgnoreCase(r.getParameter(SlackNotificationAjaxEditPageController.BUILD_FAILED)))) {
            state.enable(BuildStateEnum.BUILD_FINISHED);
        } else {
    ...
    protected ModelAndView doHandle(@NotNull HttpServletRequest request, @NotNull HttpServletResponse response) {
        ...
        if ("post".equalsIgnoreCase(request.getMethod())) {
            if ((request.getParameter(PROJECT_ID) != null)
                ...
                if (myProject != null && myUser.isPermissionGrantedForProject(myProject.getProjectId(), Permission.EDIT_PROJECT)) {
                            ...
                            if (request.getParameter(SLACK_NOTIFICATION_ID) != null) {
                                ...
                                if (content.isEnabled()) {
                                    ...
                                    if ((request.getParameter(MAX_COMMITS_DISPLAY) != null)
                                        ...
                                        content.setMaxCommitsToDisplay(convertToInt(request.getParameter(MAX_COMMITS_DISPLAY)));
                                    }
                                    ...
                                    content.setshowFunnyQuote((request.getParameter("showFunnyQuote") != null)
                                            && ("on".equalsIgnoreCase(request.getParameter("showFunnyQuote"))));
                                ...
                                checkAndAddBuildStateIfEitherSet(request, states);
                                ...
                                if ((request.getParameter("buildTypeAll") != null) && ("on".equalsIgnoreCase(request.getParameter("buildTypeAll")))) {
                                    ...
                                    if (request.getParameterValues("buildTypeId") != null) {
                                        ...
                                        buildTypes.addAll(Arrays.asList(types));
                                    }
                                }
        ...
        if ("get".equalsIgnoreCase(request.getMethod())
            ...
            if (project == null || projSettings == null) {
                return null;
            }
            ...
            if (projSettings1.getSlackNotificationsCount() == 0) {
                ...
                buildParams(params, projSettings, SLACK_NOTIFICATION);
    ...
    private int convertToInt(String s) {
        try {
            ...
            return SlackNotificationContentConfig.DEFAULT_MAX_COMMITS;
        }
    }
}
